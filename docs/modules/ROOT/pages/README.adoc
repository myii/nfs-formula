...
https://travis-ci.com/saltstack-formulas/nfs-formula[image:https://travis-ci.com/saltstack-formulas/nfs-formula.svg?branch=master[Travis CI Build Status]]
...
Creates the docker instance and runs the `nfs.server` main state, ready
for testing.
